...
export const initialEvents: ClubEvent[] = [
  {
    ...
    shortDesc:
      "A 24-hour internal hackathon to select and mentor top teams representing GEC Daman in the Smart India Hackathon 2026.",
    description:
      "The Internal Hackathon at Government Engineering College, Daman is the official screening round for SIH 2026. Teams across all departments (Computer, Electrical, Mechanical, Civil, and Biomedical) will pitch digital and hardware prototypes targeting Ministry-defined problem statements. Evaluated by academic advisors and industry professionals.",
    ...
    speakers: [
      ...
      },
      {
        ...
        role: "Assistant Professor (Computer Dept)",
        company: "GEC Daman",
        avatar:
  ...
  },
  {
    ...
    shortDesc:
      "Build and deploy high-performance web applications using modern React frameworks, hosted by Coderithum.",
    description:
      "Join Coderithum's intensive 2-day bootcamp to learn Next.js, Tailwind CSS, and TypeScript. This hands-on workshop walks through responsive layout systems, component composition, state management, and deploying applications directly onto Vercel and GitHub Pages. Perfect for beginners and intermediate coders.",
  ...
  },
  {
    ...
    banner:
      "https://images.unsplash.com/photo-1484662020986-75935d2ebc66?auto=format&fit=crop&w=1200&q=80",
    shortDesc:
      "Mastering cloud deployment, containerization, and hosting architecture for modern application frameworks.",
    description:
      "A past workshop where students set up containerized environments, wrote Dockerfiles, configured environment grids, and deployed static server templates to cloud repositories. Guided step-by-step by Coderithum technical leads.",
    date: "March 15, 2026",
