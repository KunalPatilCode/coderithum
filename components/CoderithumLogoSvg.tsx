...
interface CoderithumLogoSvgProps {
  className?: string;
  width?: number | string;
  height?: number | string;
}

export default function CoderithumLogoSvg({
  className = "w-6 h-6",
  width,
  height
}: CoderithumLogoSvgProps) {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient id="headerHashGrad" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#0B4B9A" />
          <stop offset="0.55" stopColor="#063A82" />
          <stop offset="1" stopColor="#032A61" />
        </linearGradient>
        <linearGradient id="headerBaseSideL" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#0A4B91" />
          <stop offset="1" stopColor="#167BC7" />
        </linearGradient>
        <linearGradient id="headerBaseSideR" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#167BC7" />
          <stop offset="1" stopColor="#0A4B91" />
        </linearGradient>
      </defs>
      ...
      <g id="header-base">
        <polygon
          ...
          fill="url(#headerBaseSideL)"
          stroke="#0B3C78"
          strokeWidth="4"
          strokeLinejoin="round"
        />
        <polygon
          id="header-base-right"
          points="513,962 1008,661 1008,789 513,1083"
          fill="url(#headerBaseSideR)"
          stroke="#0B3C78"
          strokeWidth="4"
          strokeLinejoin="round"
        />
      ...
      <g id="header-hash">
        ...
        {/* 12 Side Extrusions & Inner Wall Faces */}
        <g
          id="header-hash-extrusions"
          fill="url(#headerHashGrad)"
          stroke="#F8FBFF"
          strokeWidth="5"
          strokeLinejoin="round"
