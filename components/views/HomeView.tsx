    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="lg:col-span-5 flex flex-col h-full">
          <div className="p-5 rounded-none bg-theme-light border-2 border-theme/30 flex flex-col justify-between gap-5 shadow-[4px_4px_0px_#000] flex-1">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-none bg-theme-light border-2 border-theme/20 flex items-center justify-center text-theme shrink-0">
              ...
              <div className="space-y-2 pt-1.5">
                ...
                {[
                  ...
                  <div
                    ...
                    className="p-2 bg-white border border-slate-200 hover:border-theme transition-colors flex items-center justify-between gap-3 cursor-pointer group rounded-none"
                  >
                    <div className="space-y-0.5">
                      <div className="text-xs font-bold text-slate-900 group-hover:text-theme transition-colors">{evt.title}</div>
                      <div className="text-[9px] text-slate-500 font-mono">{evt.date}</div>
                    </div>
                    <ChevronRight className="w-3 h-3 text-slate-400 group-hover:text-theme transition-colors shrink-0" />
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="space-y-8">
        <div className="flex justify-between items-end border-b-2 border-slate-900 pb-4">
          <div>
            <InteractiveHeading text="Spotlight Event" as="h2" className="text-xs font-mono tracking-widest text-theme uppercase" />
            <div>
          ...
          <button onClick={() => setView("events")} className="text-xs text-theme hover:text-black font-semibold flex items-center gap-1 cursor-pointer">
          ...
          <div key={event.id} className="grid grid-cols-1 lg:grid-cols-12 gap-8 bg-white border-2 border-slate-900 rounded-none overflow-hidden group hover:border-slate-900 transition-all shadow-[6px_6px_0px_#000] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[8px_8px_0px_#000]">
            ...
            <div className="lg:col-span-6 p-8 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <h4 className="text-xl sm:text-2xl font-bold text-slate-900 group-hover:text-theme transition-colors">{event.title}</h4>
              ...
              <div className="flex flex-wrap items-center gap-4 justify-between border-t-2 border-slate-200 pt-6">
                <div className="text-xs text-slate-500 flex items-center gap-1.5"><MapPin className="w-4 h-4 text-theme" />{event.venue}</div>
                <button
                  onClick={() => { setView("event-detail"); setSelectedId(event.id); }}
                  className="px-4 py-2 bg-theme-light border-2 border-theme rounded-none text-xs font-bold text-theme hover:bg-theme hover:text-white transition-all shadow-[3px_3px_0px_#000] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[2px_2px_0px_#000] cursor-pointer"
                >
                  View Details
                </button>
              </div>
      ...
      <div className="space-y-8">
        <div className="flex justify-between items-end border-b-2 border-slate-900 pb-4">
          ...
          <button onClick={() => setView("projects")} className="text-xs text-theme hover:text-black font-semibold flex items-center gap-1 cursor-pointer">
          ...
          {projects.slice(0, 2).map(project => (
            <div key={project.id} className="p-6 rounded-none bg-white border-2 border-slate-900 hover:border-slate-900 transition-all flex flex-col justify-between space-y-6 shadow-[6px_6px_0px_#000] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[8px_8px_0px_#000] group">
              <div className="space-y-4">
                ...
                <h4 className="text-lg font-bold text-slate-900 group-hover:text-theme transition-colors">{project.title}</h4>
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-2 bg-theme-light border-2 border-theme rounded-none text-xs font-bold text-theme hover:bg-theme hover:text-white transition-all shadow-[3px_3px_0px_#000] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[2px_2px_0px_#000] cursor-pointer"
                >
      ...
      <div className="space-y-8">
        <div className="flex justify-between items-end border-b-2 border-slate-900 pb-4">
          <div>
            <InteractiveHeading text="Hall of Fame" as="h2" className="text-xs font-mono tracking-widest text-theme uppercase" />
            <div>
          ...
          <button onClick={() => setView("achievements")} className="text-xs text-theme hover:text-black font-semibold flex items-center gap-1 cursor-pointer">
          ...
          {achievements.slice(0, 3).map(ach => (
            <div key={ach.id} className="p-6 rounded-none bg-white border-2 border-slate-900 flex flex-col justify-between space-y-4 shadow-[4px_4px_0px_#000] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[5px_5px_0px_#000] transition-all">
              <div className="space-y-3">
                <div className="w-8 h-8 rounded-none bg-theme-light border-2 border-theme/20 flex items-center justify-center text-theme">
      ...
      <div className="p-6 sm:p-12 rounded-none bg-white border-2 border-slate-900 text-center space-y-6 max-w-4xl mx-auto shadow-[8px_8px_0px_#000] relative overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `radial-gradient(circle at 50% 120%, var(--theme-color), transparent 50%)` }}
        />
        ...
        <button
          ...
          className="px-6 py-3 rounded-none bg-theme border-2 border-theme-hover text-white text-sm font-bold shadow-[4px_4px_0px_#000] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[3px_3px_0px_#000] active:translate-x-[3px] active:translate-y-[3px] active:shadow-[1px_1px_0px_#000] transition-all cursor-pointer"
        >
          Get In Touch
        </button>
      </div>
